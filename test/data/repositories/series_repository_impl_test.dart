...
void main() {
  ...
  final tSeriesModelList = <SeriesModel>[testSeriesModel];
  ...
  group('On The Air Series', () {
    test(
      ...
      expect(
        resultList,
        tSeriesModelList.map((model) => model.toEntity()).toList(),
      );
    });
