...
// in ditonton/test/presentation/controller/series_detail_controller_test.dart.
...
import 'package:watchkeun/common/failure.dart' as _i6;
import 'package:watchkeun/domain/entities/series.dart' as _i9;
import 'package:watchkeun/domain/entities/series_detail.dart' as _i7;
import 'package:watchkeun/domain/repositories/series_reporitory.dart' as _i2;
import 'package:watchkeun/domain/usecases/get_recommendations_series.dart'
    as _i8;
import 'package:watchkeun/domain/usecases/get_series_detail.dart' as _i4;
import 'package:watchkeun/domain/usecases/get_watchlist_series_status.dart'
    as _i10;
import 'package:watchkeun/domain/usecases/remove_series_watchlist.dart' as _i12;
import 'package:watchkeun/domain/usecases/save_series_watchlist.dart' as _i11;
...
/// A class which mocks [GetRecommendationsSeries].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetRecommendationsSeries extends _i1.Mock
    implements _i8.GetRecommendationsSeries {
  MockGetRecommendationsSeries() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Series>>> execute(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [id],
