...
import 'package:watchkeun/common/exception.dart';
...
void main() {
  ...
  group('get On The Air Series', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('dummy_data/on_air_series.json')))
        .seriesList;
    ...
    test('should return list of Series Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$baseUrl/tv/on_the_air?$apiKey')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/on_air_series.json'), 200));
      // act
  ...
  group('get Popular Series', () {
    ...
    test('should return list of seriess when response is success (200)',
        () async {
      // arrange
  ...
  group('get Top Rated Series', () {
    ...
    test('should return list of seriess when response code is 200 ', () async {
      // arrange
  ...
  group('get series detail', () {
    const tId = 1;
    final tSeriesDetail = SeriesModel.fromJson(
  ...
  group('search series', () {
    final tSearchResult = SeriesResponse.fromJson(
            json.decode(readJson('dummy_data/search_spiderman_series.json')))
        .seriesList;
    ...
    test('should return list of series when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/search_spiderman_series.json'), 200));
      // act
